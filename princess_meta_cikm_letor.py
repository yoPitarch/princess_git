...
listCollection = [ "NP2003_50", "NP2004_50", "OHSUMED_50",
                  "TD2003_50", "TD2004_50", "HP2003_50", "HP2004_50"]
# listCollection = ['indri_web2014clueweb12_adhoc_max50']
# listCollectionDir = ["web2014", 'robust2004']
listCollectionDir = ["NP2003_50", "NP2004_50", "OHSUMED_50", "TD2003_50", "TD2004_50", "HP2003_50", "HP2004_50"]
# listCollectionDir = ["web2014"]
                                                        ...
                                                        if "swiss" in elType:  # groupswiss
                                                            for elRound in listRound:
                                                                ...
                                                                with open(dirname + '/' + sbatch_filename,
                                                                    ...
                                                                    if elFeature == '':
                                                                        the_file.write(
                                                                            'srun /logiciels/Python-2.7/bin/python2.7 /projets/sig/PROJET/PRINCESS/code/princess_git/princess_cikm_letor.py -p  ' + str(
...
def runTest(fold, best):
    ...
    command = "/logiciels/Python-2.7/bin/python2.7 " \
              "/projets/sig/PROJET/PRINCESS/code/princess_git/princess_cikm_letor.py -p " + str(nbProc) + " -x " + idfold
    t = best.split("-")
    for param in t:
        tparam = param.split(":")
        print tparam
